...
import de.telran.diplom.repository.ProtobufTransactionalRepository;

import java.time.LocalDate;

public class SimplePbuf {
    public static void main(String[] args) throws JsonMappingException {
       ...
       Transactional transactional1 = Transactional.builder()
        ...
        DataRepository<Transactional> trRep = new ProtobufTransactionalRepository();
